                ...
                {locations.map((location, index) => (
                    <motion.div key={location.id}
                        ...
                        <motion.div initial={{ opacity: 0, scale: 0.1 }}
                            ...
                            {/* Content card */}
                            <motion.div
                                className="absolute poyline-card transition-opacity duration-700 group border rounded-2xl   px-4 py-3 text-white shadow-lg dark:bg-gray-950 dark:text-gray-50"
